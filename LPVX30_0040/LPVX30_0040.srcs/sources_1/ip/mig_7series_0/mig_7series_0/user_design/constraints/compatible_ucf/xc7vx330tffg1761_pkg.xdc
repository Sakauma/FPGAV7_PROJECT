...
set_property PACKAGE_PIN AB31 [get_ports {clk_ref_p}]
...
set_property PACKAGE_PIN AB32 [get_ports {clk_ref_n}]
...
set_property PACKAGE_PIN A40 [get_ports {sys_rst}]
