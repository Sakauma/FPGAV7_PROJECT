`timescale	1ns/1ps
module	axis_convert_top#(
	parameter	CLOCK_MODE				=	"SYNC"		,	//	"IN_BLOCK"	,	"OUT_BLOCK"	or	"SYNC"
	parameter	LOOP_NUM				=	9			,
	parameter	AW						=	9			,
	parameter	DW						=	16			,
	parameter	QW						=	DW			
)(
	...
	input											o_clk					
		...
		wire		[	QW		-	1	:	0	]		obuf_tdata				;
		wire		[	4		-	1	:	0	]		obuf_tid				;
		wire											obuf_tready			    ;
		wire											obuf_tvalid			    ;
		wire		[	QW/8	-	1	:	0	]		obuf_tstrb			    ;
		wire		[	QW/8	-	1	:	0	]		obuf_tkeep			    ;
		wire											obuf_tlast			    ;
	...
	axis_convert_axs2fifo#(
		...
		.	axsr_fifo_wl		(	axsr_fifo_wl		)	,   //	output											
		.	axsr_fifo_wr		(	axsr_fifo_wr		)	,   //	output											
		.	axsr_fifo_di		(	axsr_fifo_di		)	,   //	output		[	DW		-	1	:	0	]		axsr_fifo_di
	...
	axis_convert_fifo2axs#(
		...
		.	axsr_fifo_wl		(	axsr_fifo_wl		)			,	//	input										
	...
	axis_buf#(
		...
		/* synthesis translate_off */ 
			...
			reg	[31:0]	axsr_trvl_cnt	=	0		;	always@(posedge	i_clk)	axsr_trvl_cnt	<=	i_rst	?	0		:	axsr_trvl_cnt	+	(axsr_tready	&&	axsr_tvalid	&&	axsr_tlast)	;
			reg	[31:0]	axsr_trv_cnt	=	0		;	always@(posedge	i_clk)	axsr_trv_cnt	<=	i_rst	?	0		:	axsr_tready	&&	axsr_tvalid	&&	axsr_tlast	?	0	:	axsr_trv_cnt	+	(axsr_tready	&&	axsr_tvalid)	;
			reg	[31:0]	axsr_trv_dat	=	0		;	always@(posedge	i_clk)	axsr_trv_dat	<=	i_rst	?	0		:	axsr_trv_dat	+	(axsr_tready	&&	axsr_tvalid)	;
			reg	[31:0]	ibuf_rio_type	=	'ha0	;	always@(posedge	i_clk)	ibuf_rio_type	<=	i_rst	?	'ha0	:	axsr_trv_cnt==4	&&	axsr_tready	&&	axsr_tvalid	?	axsr_tdata[15:08]	:	ibuf_rio_type	;

			wire		axsr_type_err	=	(	ibuf_rio_type	!=	8'ha0	&&	ibuf_rio_type	!=	8'h60	)	;
		...
		//	assign	axsr_fifo_di	=	{32'h0,axsr_trv_dat	};
