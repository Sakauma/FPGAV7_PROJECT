#-----------------------------------------------------------------------------
#
# File name:    srio_gen2_5g_2x_16b_ooc.xdc
# Rev:          4.0
...
#-----------------------------------------------------------------------------
    ...
    create_clock -period 8 -name log_clk_in  [get_ports log_clk_in]

    create_clock -period 8 -name phy_clk_in  [get_ports phy_clk_in]
    ...
    create_clock -period 8 -name drpclk_in  [get_ports drpclk_in]
